export default function votre_profil({ data, setData, onNext, onPrev, isLastStep, isCurrentStepComplete }) {
      ...
      <input
        ...
        style={{
          '--input-width': `${Math.max(
            data?.profileName?.length * 8 || 'Donald Draper  '.length * 8, // Start with placeholder width
