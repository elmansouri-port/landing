export default function VotreProjet3({ data, setData, onNext, onPrev, isLastStep, isCurrentStepComplete }) {
...
<div className="text-base" style={{ color: "#0A2C2D" }}>
  ...
  style={{
    '--input-width': `${Math.max(
      data?.StructurName?.length * 8 || 'Compagnie Deconcerto  '.length * 8, // Start with placeholder width
