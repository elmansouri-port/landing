export default function VotreProjet2({ data, setData, onNext, onPrev, isLastStep, isCurrentStepComplete }) {
  
  const handleCommuneNameChange = (e) => {
    setData({ ...data, CommuneName: e.target.value });
  };
  
  const clearCommuneName = () => {
    setData({ ...data, CommuneName: '' });
  };
